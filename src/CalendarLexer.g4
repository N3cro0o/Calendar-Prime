...
MONDAY_W : 'monday' | 'Monday' | 'mo' | 'Mo' | 'MO' ;
TUESDAY_W : 'tuesday' | 'Tuesday' | 'tu' | 'Tu' | 'TU' ;
WEDNESDAY_W : 'wednesday' | 'Wednesday' | 'we' | 'We' | 'WE' ;
THURSDAY_W : 'thursday' | 'Thursday' | 'th' | 'Th' | 'TH' ;
FRIDAY_W : 'friday' | 'Friday' | 'fr' | 'Fr' | 'FR' ;
SATURDAY_W : 'saturday' | 'Saturday' | 'sa' | 'Sa' | 'SA' ;
SUNDAY_W : 'sunday' | 'Sunday' | 'su' | 'Su' | 'SU' ;
PRINT_W : 'print' ;
EXPORT_W : 'export' ;
TO_W : 'to' ;
